...
public class Job {
	...
	public String toString() {
		return "Job [jid=" + jid + ", name=" + name + ", description=" + description + ", skill1=" + skill1
				+ ", skill2=" + skill2 + ", skill3=" + skill3 + ", skill4=" + skill4 + ", skill5=" + skill5
				+ ", skill6=" + skill6 + ", skill7=" + skill7 + ", skill8=" + skill8 + ", skill9=" + skill9
				+ ", skill10=" + skill10 + ", jobLocation=" + jobLocation + ", packages=" + packages + ", role=" + role
				+ ", applications=" + applications + ", company=" + company + "]";
	}
